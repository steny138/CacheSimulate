...
districs = [
    {"Country":"台北市","Districts":["中正區","大同區","中山區","松山區","大安區","信義區"]},
    {"Country":"新北市","Districts":["板橋區","新店區","永和區","中和區","三重區","新莊區"]},
    {"Country":"桃園市","Districts":["中壢區","平鎮區","龍潭區"]},
    {"Country":"台中市","Districts":["中區","東區","南區","西區","北區","北屯區","西屯區"]},
    {"Country":"台南市","Districts":["東區","南區","西區","北區","安平區","永康區","新營區","善化區","新市區"]},
    {"Country":"高雄市","Districts":["三民區","楠梓區","小港區","左營區","岡山區"]},
...
price_list = ["0", "800", "1200", "2000", "3000"]
